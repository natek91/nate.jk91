...
{
    var completeImage = document.querySelector("#jsImages");
    completeImage.innerHTML += constructImages(images);

};

constructImages = function(object) 
{
    var imageProperty = "";
    for (var i = 0; i < object.length; i++) {
        imageProperty += "<figure>";
        imageProperty += "<img src='" + object[i]["url"] + "' alt='"+ object[i]["alt"] +"'>";
        imageProperty += "<figcaption>" + object[i]["caption"] + "</figcaption>";
        imageProperty += "</figure>";
    }
