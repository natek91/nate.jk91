...
{
    var completeTable = document.querySelector("#jsTable");
    var userInfo = "<table border='1'>"+"<tr>"+"<th>"+"First Name"+"</th>"+"<th>"+"Last Name"+"</th>"+"<th>"+"Age"+"</th>"+"<th>"+"Email"+"</th>"+"</tr>";             
	for(var i=0; i < users.length; i++)
	{
		userInfo += "<tr>"+"<td>" + users[i].first_name + "</td>"+"<td>" + users[i].last_name + "</td>"+"<td>" + users[i].age + "</td>" + "<td>" + "<a href='mailto: " + users[i].email + "'>" + users[i].email + "</a></td>" + "</tr>";    
    }
    completeTable.innerHTML = userInfo;
};